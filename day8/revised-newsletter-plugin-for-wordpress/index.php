...
function newsletter_form()
{
    ...
    $content .= '<img src=" '.plugins_url("newsplugin/img/bog-billede.png").' " ';
    ...
    function register_styles_and_scripts_for_plugin() 
    {
        ...
        wp_enqueue_style('CustomStylesheet', plugins_url('newsplugin/css/style.css'));
        
        wp_deregister_script('jquery');
        
        wp_enqueue_script('jquery','https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js', array(), null, true);
        
        wp_enqueue_script('CustomScript', plugins_url('newsplugin/js/script.js'), array('jquery'), null, true);
    }
